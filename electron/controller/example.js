...
class ExampleController extends Controller {
  ...
  async dbOperation(args) {
    ...
    switch (paramsObj.action) {
      case 'add' :
        data.result = await service.jsonstorage.addData(paramsObj.addParam);
        break;
      case 'del' :
        data.result = await service.jsonstorage.delData(paramsObj.delete_name);
        break;
      case 'update' :
        data.result = await service.jsonstorage.updateData(paramsObj.updateParam);
        break;
      case 'get' :
        data.result = await service.jsonstorage.getData(paramsObj.search);
        break;
      case 'all' :
        data.all_list = await service.jsonstorage.getAllData();
        break;
    }

    // data.all_list = await service.jsonstorage.getAllTestData();
